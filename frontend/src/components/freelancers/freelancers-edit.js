...
export class FreelancersEdit {
    ...
    findElements() {
        ...
        this.levelSelectElement = document.getElementById('levelSelectInput');
    ...
    showFreelancer(freelancer) {
        ...
        if (freelancer.avatar) {
            document.getElementById('avatar').setAttribute('src', config.host + freelancer.avatar);
        }
        ...
        for (let i = 0; i < this.levelSelectElement.length; i++) {
